...
[**Visitez le site web**](https://perso.esiee.fr/~soulief/IPO/francois/)
...
Cette méthode nous permet d'éviter de répéter du code dans ``printWelcome()``
et ``printLocationInfo()``.
...
### Exercice 7.18.8
J'ai ajouté 3 boutons: Inventory, Help et Exit qui correspondent à leurs commandes respectives. Pour les placer dans une seule colonne, j'ai créé un deuxième
JPanel les contenant, que j'ai ensuite associé à l'est de vPanel.
