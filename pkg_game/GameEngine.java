...
public class GameEngine {
    ...
    private void createRooms() {
        ...
        Room vStreetW = new TransporterRoom("At the west part of the street. This is a dead end.", this.aRandom,
                "StreetW.jpg");
        ...
        Room vBusFrontA = new Room("At the front of the bus. Please take a seat at the back of the bus",
                "BusFrontA.jpg");
        Room vBusFrontB = new Room("At the front of the bus.", "BusFrontA.jpg");
        Room vBusBack = new Room(
                "At the back of the bus. You've arrived to your destination! Please get off at the front of the bus",
                "BusBack.jpg");
        Room vStreetThi = new Room(
                "In the street. You can see a big metal spike far in the distance, you're almost there!",
                "StreetThi.jpg");
        Room vStreetSec = new Room(
                "In the street. You're getting closer, only a few meters left before you're at school, keep it up!\nYou cross path with some Gilet Jaunes...",
                "StreetSec.jpg");
        ...
        vStreetSec.addCharacter(
                new GameCharacter("Robert", "Les gilets jaunes sont la France de la mondialisation malheureuse!"));
        vStreetSec.addCharacter(new GameCharacter("Nathalie",
    ...
    public String getEndString(Player pP) {
        if (pP.hasItem("Bag"))
            return "Congratulations, you got to ESIEE in time and didn't forget your school bag. You WIN!";
        else
            return "You forgot your school bag! You lost.";
    }
